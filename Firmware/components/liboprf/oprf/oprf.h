...
#ifdef ESPRESSIF_ESP32
///This block is required for the ESP32, the library expects sodium_mlock and sodium_munlock to return 0, but they will forever return -1 on the ESP32 due to nonimplementation.
static inline int esp32_sodium_lock_stub(void* a, size_t l) { return 0; }

#define sodium_mlock(a, l) esp32_sodium_lock_stub(a, l)
#define sodium_munlock(a, l) esp32_sodium_lock_stub(a, l)
#endif
#endif
